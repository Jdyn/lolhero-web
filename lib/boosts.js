export default {
  ...
  // Duo: {
  //   name: 'Duo Boost',
  //   description: 'DUO means you will play alongside our coach with voice communication.',
  //   subdescription: " if you don't want to play, you can select SOLO.",
  //   color: '#e53935',
  //   items: [
  //     {
  ...
  //       maxAmount: '1',
  //       id: 9,
  //       description: 'We play the required amount of games to reach the division you choose.'
  //     },
  //     {
  //       title: 'Placement Games',
  //       tag: 'duo',
